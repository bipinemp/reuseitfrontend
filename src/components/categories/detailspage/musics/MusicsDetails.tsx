...
import MusicsSpecific from "./MusicsSpecific";

interface EDetailsProps {
  ProductDetails: EMusicsDetails;
}

const MusicsDetails: React.FC<EDetailsProps> = ({ ProductDetails }) => {
  return (
    <div className="max-w-[1920px] mx-auto px-4  md:px-10 xl:px-10 2xl:px-80">
      <div className="flex flex-col gap-10 mb-10">
        ...
        <div className="flex flex-col gap-5">
          <MusicsSpecific
            accessories_included={ProductDetails.accessories_included}
