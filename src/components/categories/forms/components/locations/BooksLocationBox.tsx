...
import { TAppliance, TBooks } from "@/types/postTypes";
import { Control, FieldErrors } from "react-hook-form";

interface LocationBoxProps {
  control: Control<TBooks>;
  errors: FieldErrors<TBooks>;
}

const BooksLocationBox: React.FC<LocationBoxProps> = ({ control, errors }) => {
...
export default BooksLocationBox;
