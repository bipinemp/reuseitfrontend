...
import { TMusic } from "@/types/postTypes";
import { Control, FieldErrors } from "react-hook-form";

interface LocationBoxProps {
  control: Control<TMusic>;
  errors: FieldErrors<TMusic>;
}

const MusicLocationBox: React.FC<LocationBoxProps> = ({ control, errors }) => {
...
export default MusicLocationBox;
