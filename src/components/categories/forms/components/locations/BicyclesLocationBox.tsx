...
import { TBicycles } from "@/types/postTypes";
import { Control, FieldErrors } from "react-hook-form";

interface LocationBoxProps {
  control: Control<TBicycles>;
  errors: FieldErrors<TBicycles>;
  whileEditing?: boolean;
  Prov?: string;
  Dist?: string;
}

const BicyclesLocationBox: React.FC<LocationBoxProps> = ({
  control,
  errors,
  whileEditing,
  Prov,
...
export default BicyclesLocationBox;
