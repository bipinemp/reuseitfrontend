...
import { TFurnitures, TSports } from "@/types/postTypes";
import { Control, FieldErrors } from "react-hook-form";

interface LocationBoxProps {
  control: Control<TSports>;
  errors: FieldErrors<TSports>;
}

const SportsLocationBox: React.FC<LocationBoxProps> = ({ control, errors }) => {
...
export default SportsLocationBox;
