...
import SportsLocationBox from "../forms/components/locations/SportsLocationBox";
...
const EditSports: React.FC<EDetailsProps> = ({ ProductDetails, fnname }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      size_weight: ProductDetails.size_weight,
      suitable_sport_activity: ProductDetails.suitable_sport_activity,
      usage_instructions: ProductDetails.usage_instructions,
      type_of_equipment: ProductDetails.type_of_equipment,
