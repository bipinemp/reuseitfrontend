...
const ProductCard: React.FC<ProductProps> = ({ product }) => {
  ...
  return (
    <div className="cursor-pointer hover:border-primary transition aspect-square w-full max-h-[310px] col-span-1 shadow-md border-[2px] border-gray rounded-md px-2 pt-2 pb-2 flex flex-col gap-2">
